// Type definitions for sjcl v1.0.4
// Project: http://crypto.stanford.edu/sjcl/
// Definitions by: Eugene Chernyshov <https://github.com/Evgenus>, Rob Yoder
...
declare namespace sjcl {
    ...
    interface SjclCodecWithPadding<T> {
        fromBits(bits: BitArray, noPad?: boolean): T;
        toBits(value: T): BitArray;
    }
    ...
    interface SjclCodecs {
        ...
        // [robyoder 2016.04.20] sjcl doesn't actually create a Uint8Array in fromBits,
        // but we should require one when using toBits just to be safe.
        bytes: {
            fromBits(bits: BitArray): number[];
            toBits(value: Uint8Array): BitArray;
        };
        base64: SjclCodecWithPadding<string>;
        base32: SjclCodecWithPadding<string>;
        base64url: SjclCodec<string>;
        base32hex: SjclCodecWithPadding<string>;
    }
